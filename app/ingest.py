...
SOURCES: list[dict[str, str]] = [
    ...
    {
        "name": "Wikipédia FR — LMNP (Location meublée non professionnelle)",
        "url": "https://fr.wikipedia.org/wiki/LMNP",
        "kind": "html",
        "category": "regulation",
    },
    {
        "name": "Wikipédia FR — Denormandie (dispositif)",
        "url": "https://fr.wikipedia.org/wiki/Denormandie",
        "kind": "html",
        "category": "regulation",
    },
    {
    ...
    {
        "name": "Wikipédia FR — Encadrement des loyers",
        "url": "https://fr.wikipedia.org/wiki/Encadrement_des_loyers",
        "kind": "html",
        "category": "regulation",
    },
    {
        "name": "Wikipédia FR — Gestion de patrimoine",
        "url": "https://fr.wikipedia.org/wiki/Gestion_de_patrimoine",
        "kind": "html",
        "category": "compliance",
    },
    {
    ...
    {
        "name": "Wikipédia FR — Immobilier en France",
        "url": "https://fr.wikipedia.org/wiki/Immobilier_en_France",
        "kind": "html",
        "category": "methodology",
    },
    {
        "name": "Wikipédia FR — Investissement locatif",
        "url": "https://fr.wikipedia.org/wiki/Investissement_locatif",
        "kind": "html",
        "category": "methodology",
    },
]
